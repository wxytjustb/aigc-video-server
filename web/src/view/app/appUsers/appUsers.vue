  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt" width="180">
            ...
            <el-table-column align="left" label="Casdoor/OIDC Issuer" prop="oidcIssuer" width="120" />

            <el-table-column align="left" label="OIDC sub" prop="oidcSub" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateAppUsersFunc(scope.row)">编辑</el-button>
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="Casdoor/OIDC Issuer:" prop="oidcIssuer">
    <el-input v-model="formData.oidcIssuer" :clearable="true" placeholder="请输入Casdoor/OIDC Issuer" />
</el-form-item>
            <el-form-item label="OIDC sub:" prop="oidcSub">
    <el-input v-model="formData.oidcSub" :clearable="true" placeholder="请输入OIDC sub" />
</el-form-item>
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="查看">
            <el-descriptions :column="1" border>
                    <el-descriptions-item label="Casdoor/OIDC Issuer">
    {{ detailForm.oidcIssuer }}
</el-descriptions-item>
                    <el-descriptions-item label="OIDC sub">
    {{ detailForm.oidcSub }}
</el-descriptions-item>
